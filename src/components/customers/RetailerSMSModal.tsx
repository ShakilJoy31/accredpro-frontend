...
interface RetailerSMSModalProps {
    isOpen: boolean;
    retailerId: number;
    phoneNumber: string;
    onClose: () => void;
...
const HARDCODED_SMS_CONFIG = {
    id: 1,
    appName: "MyMarketingApp",
    apiKey: "C400102369708eca4d1604.85945999",
    type: "unicode",
    senderId: "Ring Tel",
    message: "Welcome to brother's enterprise.",
    status: true
};

const RetailerSMSModal: React.FC<RetailerSMSModalProps> = ({
    isOpen,
    retailerId,
    phoneNumber,
    onClose,
    ...
    // Use hardcoded config instead of API call
    const smsConfigs = [HARDCODED_SMS_CONFIG];
    const isLoadingConfigs = false;
    const selectedConfigId = 1; // Always use the hardcoded config ID
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Content */}
                <div className="p-6 space-y-6 max-h-[50vh] scrollbar-hide overflow-y-auto">
                    {/* SMS Config Info - Hardcoded */}
...
export default RetailerSMSModal;