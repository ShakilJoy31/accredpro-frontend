...
export default function PublicNav() {
  ...
  const isActiveLink = (linkPath: string) => {
    ...
    if (linkPath === '/service') {
      return (
        pathname === '/service' ||
        pathname.startsWith('/service/service-details/')
      );
    }
  ...
  return (
    ...
    >
      <div className='max-w-[1280px] mx-auto w-full flex items-center justify-between h-16 px-4'>
        ...
        <div className='hidden md:flex items-center gap-2 lg:gap-3'>
          ...
          <Button
            ...
            className={`bg-gradient-to-r from-green-700 to-blue-600 text-white px-5 py-2 lg:px-7 rounded-full text-sm font-semibold whitespace-nowrap transition-all duration-300 shadow-sm hover:shadow-md transform hover:scale-105 active:scale-95`}
          >
            Login
          </Button>
        </div>
        ...
        <div className='lg:hidden flex items-center gap-2'>
          ...
          <button
            ...
            className='text-gray-700 rounded-md focus:outline-none'
      ...
      {isOpen && (
        <div className='lg:hidden bg-gray-300 border-t'>
