...
import { useGetDriverStatsQuery } from '@/redux/api/customer/driverApi';
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} p-2 md:p-3 lg:p-4`}>
                ...
                <div className="flex items-center gap-4 mb-4">
                    <div>
                        ...
                        <p className={`mt-1 text-sm md:text-base ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}`}>
                            Manage all your drivers, their vehicles, and track their trips and earnings
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div className="flex-1">
                            ...
                            <p className={`mt-2 ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>
                                Here you can manage all your drivers - their personal information, vehicle details,
                                employment contracts, payment terms, and track their trips and earnings.
                            </p>
            ...
            {statsLoading ? (
                ...
                <DriverStatsCards stats={statsData.data} />
            )}
