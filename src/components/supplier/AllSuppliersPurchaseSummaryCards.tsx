...
interface AllSuppliersPurchaseSummaryCardsProps {
  summary: any;
  isLoading: boolean;
  selectedYear: string;
...
const AllSuppliersPurchaseSummaryCards: React.FC<AllSuppliersPurchaseSummaryCardsProps> = ({
  summary,
  isLoading,
  selectedYear,
  onYearChange
  ...
  const cards = [
    ...
    },
    {
      ...
      value: summary.overall.totalSuppliers,
      icon: Building2,
    ...
    },
    {
      ...
      value: summary.overall.activeSuppliers,
      icon: Package,
      color: 'text-cyan-500',
        ...
        <div className={`rounded-2xl p-5 mt-4 ${theme === 'dark'
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {summary.topSuppliers.map((supplier: any, idx: number) => (
                  <tr key={idx} className={`border-b ${theme === 'dark' ? 'border-gray-700/50' : 'border-gray-200/50'}`}>
                    ...
                    <td className="px-3 py-2 text-right">
                      <span className={parseFloat(supplier.outstandingBalance) > 0 ? 'text-orange-500' : 'text-green-500'}>
...
export default AllSuppliersPurchaseSummaryCards;